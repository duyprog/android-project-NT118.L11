import {FETCHING_DETAIL_FAILURE, FETCHING_DETAIL_SUCCESS, FETCHING_DETAIL_REQUEST, FETCHING_CURRENT_RECEIPT_REQUEST, FETCHING_CURRENT_RECEIPT_SUCCESS, FETCHING_CURRENT_RECEIPT_FAILURE, CONFIRM_RECEIPT} from '../actions/types';
const initialState = { 
    receiptDetailData: 
    {
        receiptDetail: [], 
