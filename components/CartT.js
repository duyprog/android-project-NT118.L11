...
import Table from '../image/mainMenu/take-away.png'
function CartT ({item, chooseReceiptToSee,getTableIdByRId, nav}) {
        ...
        <TouchableOpacity
            ...
            <View style={styles.view}>
                ...
                <View style={{justifyContent: 'center', marginLeft: 20}}>
                    <Text style={styles.textTable}>Mã đơn hàng: {item.TBID} </Text>
...
export default connect(null, {chooseReceiptToSee, getTableIdByRId})(CartT);